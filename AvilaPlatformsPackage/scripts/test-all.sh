...
# Run all tests for AvilaPlatforms

set -e

echo "🧪 Running AvilaPlatforms Test Suite"
echo "================================="
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    if [ -f "AvilaPlatforms.xcworkspace" ]; then
        xcodebuild test \
            -workspace AvilaPlatforms.xcworkspace \
            -scheme AvilaPlatforms \
