...
# Start AvilaPlatforms development environment

set -e

echo "🚀 Starting AvilaPlatforms Development Environment"
echo "==============================================="
...
echo -e "\n${BLUE}📱 iOS App:${NC}"
echo -e "   Open Xcode: ${YELLOW}open ios-app/AvilaPlatforms.xcodeproj${NC}"
echo -e "   Or use: ${YELLOW}cd ios-app && pod install && open AvilaPlatforms.xcworkspace${NC}"
