...
# AvilaPlatforms Setup Script
# This script sets up the development environment

set -e

echo "🚀 AvilaPlatforms Setup Script"
echo "================================"
...
if [ "$START_DB" = "y" ]; then
    ...
    docker-compose exec postgres psql -U postgres -d avilaplatforms -f /docker-entrypoint-initdb.d/schema.sql || echo -e "${YELLOW}⚠️  Schema already applied${NC}"
fi
...
echo -e "4. Open iOS app in Xcode: ${YELLOW}open ios-app/AvilaPlatforms.xcodeproj${NC}"
