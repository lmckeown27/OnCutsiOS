...
-- GRANT SELECT, INSERT, UPDATE ON escrows TO avilaplatforms_user;
-- GRANT SELECT ON escrow_details TO avilaplatforms_user;
-- GRANT USAGE, SELECT ON SEQUENCE escrows_id_seq TO avilaplatforms_user;
