...
GRANT SELECT, INSERT, UPDATE ON circle_transactions TO avilaplatforms_user;
GRANT USAGE, SELECT ON SEQUENCE circle_transactions_id_seq TO avilaplatforms_user;
GRANT SELECT ON circle_transaction_history TO avilaplatforms_user;
