 ...
 * 
 * One-time setup script to create a wallet set for AvilaPlatforms.
...
async function main() {
  ...
  try {
    console.log('Creating wallet set "AvilaPlatforms Main"...\n');
    
    const walletSetId = await usdcService.createWalletSet('AvilaPlatforms Main');
