...
// Admin contact info
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'admin@avilaplatforms.com';
  ...
  private async sendAlerts(status: GasWalletStatus): Promise<void> {
    ...
    try {
      ...
      const emailBody = `
        ...
        <h3>How to Fund:</h3>
        <ol>
          <li>Go to <a href="https://avilaplatforms.com/admin">Admin Dashboard</a></li>
              ...
              elements: [
                {
                  ...
                  url: 'https://avilaplatforms.com/admin',
