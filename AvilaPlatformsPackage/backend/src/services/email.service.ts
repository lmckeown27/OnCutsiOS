/**
 * Email Service - SMTP Email Verification for AvilaPlatforms
 * 
 ...
 * 
 * @example
 * await sendEmail('admin@avilaplatforms.com', 'Alert', 'Gas wallet is low!');
 */
 ...
 * 
 * @example
 * const resetLink = `https://avilaplatforms.com/reset-password?token=${token}`;
