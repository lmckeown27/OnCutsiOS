/**
 * Push Notification Service for AvilaPlatforms
...
class PushNotificationService {
  ...
  private async sendIOSNotification(deviceToken: string, notification: NotificationData): Promise<any> {
    ...
    note.topic = process.env.APN_BUNDLE_ID || 'com.avilaplatforms.ios';
    ...
    const message = {
      ...
      android: {
        ...
        notification: {
          ...
          channelId: 'avilaplatforms_notifications',
        },
      },
    };
