...
-- GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.payment_transactions TO avilaplatforms;

-- Optional: default privileges for future tables created by migrations run as superuser:
-- ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO avilaplatforms;
