# AvilaPlatforms iOS Design System

> A comprehensive guide for building the native iOS frontend based on the AvilaPlatforms web platform.
...
### Brand Name
**AvilaPlatforms** (also referenced as CampusCut or CampusKinect in some branding)

### Brand Positioning
AvilaPlatforms is a peer-to-peer campus haircut marketplace connecting student barbers with customers. The platform emphasizes:
...
### Logo
- Primary logo: Chair icon with "AvilaPlatforms" wordmark
...
**Header:**
- Navigation title: "AvilaPlatforms"
