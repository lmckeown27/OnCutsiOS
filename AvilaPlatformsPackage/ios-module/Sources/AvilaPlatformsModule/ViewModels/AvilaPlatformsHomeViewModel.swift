//
//  AvilaPlatformsHomeViewModel.swift
//  AvilaPlatformsModule
//
//  Internal ViewModel for the main AvilaPlatforms home screen.
//
...
@MainActor
internal class AvilaPlatformsHomeViewModel: ObservableObject {
    ...
    private let apiService: AvilaPlatformsAPIService
    ...
    init(session: UserSessionProtocol, apiService: AvilaPlatformsAPIService) {
