//
//  AvilaPlatformsClient+ShellProfile.swift
...
public struct AvilaPlatformsProfileBooking: Sendable, Identifiable, Hashable {
    public let id: Int
...
public struct AvilaPlatformsBarberReviewSnippet: Sendable, Identifiable, Hashable {
...
extension AvilaPlatformsClient {
    ...
    public func fetchBarberPortfolioURLs(barberId: Int) async throws -> [URL] {
        ...
        return paths.compactMap { AvilaPlatformsS3ImageURL.url(forStoredPath: $0) }
    }
    ...
    public func fetchBarberReviewSnippets(barberId: Int) async throws -> [AvilaPlatformsBarberReviewSnippet] {
        let api = AvilaPlatformsAPIService(session: session, environment: environment)
    ...
    private static func mapBookingToProfile(_ b: Booking) -> AvilaPlatformsProfileBooking? {
        ...
        return AvilaPlatformsProfileBooking(
            id: b.id,
            serviceName: service,
    ...
    private static func mapReview(_ r: Review) -> AvilaPlatformsBarberReviewSnippet {
        ...
        return AvilaPlatformsBarberReviewSnippet(
            id: "rev-\(r.id)",
            authorName: name,
            rating: r.rating,
            body: body,
