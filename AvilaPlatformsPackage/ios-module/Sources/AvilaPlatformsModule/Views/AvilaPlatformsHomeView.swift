...
internal struct AvilaPlatformsHomeView: View {
    @StateObject var viewModel: AvilaPlatformsHomeViewModel
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("AvilaPlatforms")
            .toolbar {
                #if os(iOS)
...
internal struct BarberCardView: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            // Profile Image
            AsyncImage(url: AvilaPlatformsS3ImageURL.url(forStoredPath: barber.profileImageUrl)) { image in
                image
                    .resizable()
