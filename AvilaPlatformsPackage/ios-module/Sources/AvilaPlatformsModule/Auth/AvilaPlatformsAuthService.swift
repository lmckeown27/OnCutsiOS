...
public typealias AvilaPlatformsAuthSession = AvilaPlatformsVerifiedSession

// MARK: - Sign-in surface (labels / analytics — OAuth UI lives in the host app)

public enum AvilaPlatformsSignInProvider: String, Sendable {
    case google
    case apple
    case email
}

/// High-level onboarding entry points. Wraps `AvilaPlatformsSignUpAPI` so future packages can share the same call shape.
public enum AvilaPlatformsAuthService {
    ...
    public static func sendRegistrationVerificationEmail(
        ...
        try await AvilaPlatformsSignUpAPI.register(apiV1BaseTrimmed: apiV1BaseTrimmed, request: request)
    }
    ...
    public static func sendPhoneSignupCode(
        ...
        try await AvilaPlatformsSignUpAPI.sendPhoneSignupCode(
    ...
    public static func verifyPhoneSignupCode(
        ...
        try await AvilaPlatformsSignUpAPI.verifyPhoneSignupCode(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            phone: phone,
            code: code
        )
    ...
    public static func completePhoneSignup(
        ...
        try await AvilaPlatformsSignUpAPI.completePhoneSignup(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
    ...
    public static func resendVerification(
        ...
        try await AvilaPlatformsSignUpAPI.resendVerification(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            phone: phone
        )
    ...
    public static func verify(
        ...
        try await AvilaPlatformsSignUpAPI.verifyEmail(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            phone: phone,
            code: code
    ...
    public static func verify(code: String, email: String, apiV1BaseTrimmed: String) async throws -> AvilaPlatformsVerifiedSession {
    ...
    public static func checkAccount(email: String, apiV1BaseTrimmed: String) async throws -> Bool {
        try await AvilaPlatformsSignUpAPI.checkEmailExists(apiV1BaseTrimmed: apiV1BaseTrimmed, email: email)
    }
    ...
    public static func loginWithEmailPassword(
        ...
        try await AvilaPlatformsSignUpAPI.login(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            password: password
        )
