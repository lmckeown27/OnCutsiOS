//
//  AvilaPlatformsAuthTokenStore.swift
...
/// Persists AvilaPlatforms API tokens in the iOS Keychain (shared by the host app and this module).
public enum AvilaPlatformsAuthTokenStore: Sendable {
    private static let service = "com.avilaplatforms.module.auth"
