          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                ...
                <strong>Stripe Connect</strong> account—AvilaPlatforms does <strong>not</strong> hold barber payout funds.
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Your share is transferred to your connected account. AvilaPlatforms does not pool or hold that money for
                  you.
                </p>
              </div>
            </div>
