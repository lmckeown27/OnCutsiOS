...
# AvilaPlatforms Frontend - Complete Docker Deployment Script
# Builds and deploys the frontend application

set -e  # Exit on error

echo "════════════════════════════════════════════════════════"
echo "  🏆 AvilaPlatforms Frontend - Docker Deployment"
echo "════════════════════════════════════════════════════════"
echo ""
...
echo "  View logs:    docker logs -f avilaplatforms-frontend"
echo "  Stop:         docker stop avilaplatforms-frontend"
echo "  Restart:      docker restart avilaplatforms-frontend"
echo "  Shell access: docker exec -it avilaplatforms-frontend sh"
echo ""
