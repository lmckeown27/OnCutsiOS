...
# AvilaPlatforms - Minimal Build Fix Script
# Makes the web-app build successfully by simplifying to a base website

set -e  # Exit on error

echo "🔧 Fixing AvilaPlatforms web-app for minimal successful build..."
echo ""
...
// App Metadata
export const APP_NAME = import.meta.env.VITE_APP_NAME || 'AvilaPlatforms';
