/// AvilaPlatforms User Accounts Module
/// 
...
module avila_platforms::user_accounts {
    use std::signer;
    ...
    public entry fun register_user(
        ...
        // Update registry
        let registry = borrow_global_mut<UserRegistry>(@avila_platforms);
    ...
    public fun get_total_users(): (u64, u64, u64) acquires UserRegistry {
        let registry = borrow_global<UserRegistry>(@avila_platforms);
