...
//  Transferred from CampusKinect with AvilaPlatforms adaptations
//
...
// MARK: - Keychain Keys
struct KeychainKeys {
    static let accessToken = "avilaplatforms.accessToken"
    static let refreshToken = "avilaplatforms.refreshToken"
    static let userID = "avilaplatforms.userID"
    static let userType = "avilaplatforms.userType" // "student" or "barber"
    static let biometricEnabled = "avilaplatforms.biometricEnabled"
}
...
class KeychainManager {
    ...
    private let service = "com.avilaplatforms.ios"
