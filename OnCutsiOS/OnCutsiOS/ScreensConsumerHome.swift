...
// MARK: - Home shell (`OnCutsChatManager`)
...
struct ConsumerHomeScreen: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .onCutsStartProviderChat)) { output in
...
struct ServiceProviderDetailSheet: View {
    ...
    private var liveDataSafetyMode: Bool { AppConfiguration.onCutsProductionLiveDataMode }
