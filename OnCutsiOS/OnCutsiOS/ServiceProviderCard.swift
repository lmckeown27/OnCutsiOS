...
/// - Haircut providers (from OnCuts package)
...
struct ServiceProvider: Identifiable, Codable {
    ...
    /// Mock haircut providers (simulates data from OnCuts platform)
...
/*
 ...
 - OnCuts: Barber model (see Barber.swift)
 ...
 - OnCutsAdapter: Barber → ServiceProvider
