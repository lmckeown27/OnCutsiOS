...
When you add real platform packages (OnCuts, Beauty, etc.), the adapters will map platform-specific providers to the correct category:

### OnCuts Package → `.haircuts`
...
1. Import the package (e.g., OnCuts)
