...
final class MainCoordinator {
    ...
    /// Navigate to the OnCuts module
    /// When you add the OnCuts package, uncomment and use this:
    /*
    func showOnCutsModule() {
        guard let session = sessionManager.currentSession else { return }
        
        // This will be called when OnCutsModuleBuilder is available
        // let moduleView = OnCutsModuleBuilder.build(with: session)
