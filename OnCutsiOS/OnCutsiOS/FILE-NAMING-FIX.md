...
- `Barber.swift` (in OnCuts package)
...
static let haircutMocks: [ServiceProvider]  // Simulates OnCuts data
...
└── Packages/
    └── OnCuts/
        ...
        │
        └── Adapters/
            └── OnCutsAdapter.swift ✅ Converts to ServiceProvider
```
...
**Q: What about the OnCuts `Barber.swift` file?**
A: Keep it! That's in the OnCuts package and should be platform-specific. Only shell app files need generic naming.
