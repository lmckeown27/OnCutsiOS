# OnCuts Design System Implementation
...
2. **DesignSystemTypography.swift**
   ...
   - Custom text style modifier `.onCutsStyle()`
...
```swift
Text("Welcome")
    .onCutsStyle(.displayLarge)  // Large heading

Text("Description")
    .onCutsStyle(.bodyMedium)    // Body text

Text("Label")
    .onCutsStyle(.caption)        // Small text
```
...
5. **Branded**: OnCuts identity throughout
