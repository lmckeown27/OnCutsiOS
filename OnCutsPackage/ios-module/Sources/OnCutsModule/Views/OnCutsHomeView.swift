...
internal struct OnCutsHomeView: View {
    @StateObject var viewModel: OnCutsHomeViewModel
...
internal struct BarberCardView: View {
    ...
    var body: some View {
        HStack(spacing: 16) {
            // Profile Image
            AsyncImage(url: OnCutsS3ImageURL.url(forStoredPath: barber.profileImageUrl)) { image in
                image
                    .resizable()
