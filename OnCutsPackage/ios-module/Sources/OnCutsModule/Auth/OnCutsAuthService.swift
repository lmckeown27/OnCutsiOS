...
public typealias OnCutsAuthSession = OnCutsVerifiedSession

// MARK: - Sign-in surface (labels / analytics — OAuth UI lives in the host app)

public enum OnCutsSignInProvider: String, Sendable {
    case google
    case apple
    case email
}

/// High-level onboarding entry points. Wraps `OnCutsSignUpAPI` so future packages can share the same call shape.
public enum OnCutsAuthService {
    ...
    public static func sendRegistrationVerificationEmail(
        ...
        try await OnCutsSignUpAPI.register(apiV1BaseTrimmed: apiV1BaseTrimmed, request: request)
    }
    ...
    public static func sendPhoneSignupCode(
        ...
        try await OnCutsSignUpAPI.sendPhoneSignupCode(
    ...
    public static func verifyPhoneSignupCode(
        ...
        try await OnCutsSignUpAPI.verifyPhoneSignupCode(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            phone: phone,
            code: code
        )
    ...
    public static func completePhoneSignup(
        ...
        try await OnCutsSignUpAPI.completePhoneSignup(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
    ...
    public static func resendVerification(
        ...
        try await OnCutsSignUpAPI.resendVerification(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            phone: phone
        )
    ...
    public static func verify(
        ...
        try await OnCutsSignUpAPI.verifyEmail(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            phone: phone,
            code: code
    ...
    public static func verify(code: String, email: String, apiV1BaseTrimmed: String) async throws -> OnCutsVerifiedSession {
    ...
    public static func loginWithEmailPassword(
        ...
        try await OnCutsSignUpAPI.login(
            apiV1BaseTrimmed: apiV1BaseTrimmed,
            email: email,
            password: password
        )
