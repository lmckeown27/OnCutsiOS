//
//  AvilaPlatformsReviewModels.swift
//  Intera
//
//  Decodes AvilaPlatforms `Review` payloads (barber list embed + GET /barbers/:id/reviews).
//
...
struct AvilaPlatformsReviewDTO: Decodable, Sendable {
    let id: String?
...
struct AvilaPlatformsBarberReviewsListResponse: Decodable, Sendable {
    let success: Bool?
    let data: [AvilaPlatformsReviewDTO]?
}

// MARK: - Map → UI model

extension AvilaPlatformsReviewDTO {
...
extension Array where Element == AvilaPlatformsReviewDTO {
