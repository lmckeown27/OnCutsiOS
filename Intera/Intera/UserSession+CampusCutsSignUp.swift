//
//  UserSession+CampusCutsSignUp.swift
//  Intera
//
//  Maps `CampusCutsModule` email verification session into the shell `UserSession`.
//
...
extension UserSession {
    init(campusCutsVerified s: CampusCutsVerifiedSession) {
        let role: UserRole
